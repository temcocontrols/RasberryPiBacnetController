 ...
 * 
 * Description: 
 * This header file contains the definitions for the base class RS485.
 *
 * Created:
 * Author:
 *****************************************************************************/
...
typedef enum {
	DL_UNITDATArequest, 
	DL_UNITDATAindication
} DATALINKPrimitive;

typedef enum {
	N_UNITDATArequest, 
	N_UNITDATAindication
} NETWORKPrimitive;

typedef enum {
	NORMALmessage, 
	URGENTmessage, 
	CRITICALEQUIPTMENTmessage, 
	LIFESAFETYmessage
} NetworkPriority;
...
typedef enum {
	...
	CONF_SERVconfirm,
	UNCONF_SERVrequest, 
	UNCONF_SERVindication, 
	ERRORrequest, 
	ERRORindication,
	REJECTrequest, 
	REJECTindication, 
	SEGMENT_ACKrequest,  
	SEGMENT_ACKindication,
	ABORTrequest, 
	ABORTindication
} ServicePrimitive;
...
typedef enum { 
	MSTP_MASTER_IDLE, 
	MSTP_MASTER_USE_TOKEN, 
	MSTP_MASTER_WAIT_FOR_REPLY,
	MSTP_MASTER_DONE_WITH_TOKEN, 
	MSTP_MASTER_PASS_TOKEN, 
	MSTP_MASTER_NO_TOKEN,
	MSTP_MASTER_POLL_FOR_MASTER, 
	MSTP_MASTER_ANSWER_DATA_REQUEST 
} MSTP_MASTERStateEnum;

typedef enum { 
	CTSM_IDLE, 
	CTSM_SEGMENTING_REQUEST, 
	CTSM_AWAIT_CONFIRMATION,
	CTSM_AE_SEGMENTED_CONFIRMATION 
} ClientTSMStateEnum;

typedef enum {
	STSM_IDLE, 
	STSM_SEGMENTING_REQUEST, 
	STSM_AWAIT_RESPONSE, 
	STSM_SEGMENTING_RESPONSE
} ServerTSMStateEnum;
