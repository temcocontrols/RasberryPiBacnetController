...
*                        specific.  See OS_TASK_OPT_??? in MT.H.  Current choices are:
*
...
*              OS_ERR_TASK_DEL_IDLE    if you attempted to delete MTK's idle task
*              OS_ERR_PRIO_INVALID     if the priority you specify is higher that the maximum allowed
...
*              OS_ERR_TASK_DEL_IDLE   if you requested to delete MTK's idle task
*              OS_ERR_PRIO_INVALID    if the priority you specify is higher that the maximum allowed
*                                     (i.e. >= OS_LOWEST_PRIO) or, you have not specified OS_PRIO_SELF.
...
*              opt      contains additional information (or options) about the behavior of the task.  The
*                       LOWER 8-bits are reserved by MTK while the upper 8 bits can be application
*                       specific.  See OS_TASK_OPT_??? in MT.H.
*
* Returns    : none
*********************************************************************************************************
*/
