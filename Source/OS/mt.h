...
#define  OS_VERSION                 29211u              /* Version of MTK (Vx.yy mult. by 10000)  */
...
#define  OS_TICK_STEP_WAIT              1u  /* Waiting for MT-View to set OSTickStepState to _ONCE  */
#define  OS_TICK_STEP_ONCE              2u  /* Process tick once and wait for next cmd from MT-View */
#endif
...
#error  "OS_CFG.H, Missing OS_CPU_HOOKS_EN: MTK hooks are found in the processor port files when 1"
#endif


#ifndef OS_APP_HOOKS_EN
#error  "OS_CFG.H, Missing OS_APP_HOOKS_EN: Application-defined hooks are called from the MTK hooks"
#endif
...
#error  "OS_CFG.H, Missing OS_TICK_STEP_EN: Allows to 'step' one tick at a time with MT-View"
#endif
