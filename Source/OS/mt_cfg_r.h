...
#define OS_CFG_H
                                       ...
                                       /* ---------------------- MISCELLANEOUS ----------------------- */
#define OS_APP_HOOKS_EN           1u   /* Application-defined hooks are called from the MTK hooks */
#define OS_ARG_CHK_EN             1u   /* Enable (1) or Disable (0) argument checking                  */
#define OS_CPU_HOOKS_EN           1u   /* MTK hooks are found in the processor port files         */
...
#define OS_TICK_STEP_EN           1u   /* Enable tick stepping feature for MT-View                  */
