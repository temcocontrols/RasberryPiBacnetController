 ...
 * 
 * Description: 
 * This header file has all of the definitions and prototypes needed to use the
 * Modem class. This file should be included by any module that uses the Modem
 * class.
 *
 * Created:
 * Author:
